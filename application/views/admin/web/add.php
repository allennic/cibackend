            ...
            <div class="col-md-12 ">
                <div class="portlet box green ">
                    ...
                    <div class="portlet-body form">
                        <form class="form-horizontal" id="myvaliForm" role="form" action="<?php echo base_url('admin/web/add')?>" method="post">
                            <div class="form-body">

                                <div class="form-group">
                                    <label class="col-md-3 control-label">职位</label>
                                    <div class="col-md-9">
                                        <input type="text" name="web_job"class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="web_phone" class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group last">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="web_qq" class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">邮箱</label>
                                    <div class="col-md-9">
                                        <input type="text" name="web_email" class="form-control" >
                                    </div>
                                </div>
                            </div>
    ...
    $(function () {
        $("#myvaliForm").bootstrapValidator({
            ...
            .on('success.form.bv', function(e) {
                ...
                $.ajax({
                    url: '<?php echo base_url('/admin/web/add')?>',
                    type: 'POST',
