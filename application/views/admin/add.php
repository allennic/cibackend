            ...
            <div class="col-md-12 ">
                <div class="portlet box green ">
                    <div class="portlet-title">
                        ...
                        <div class="tools">
                            <a bossef="" class="collapse">
                            </a>
                            <a bossef="#portlet-config" data-toggle="modal" class="config">
                            </a>
                            <a bossef="" class="reload">
                            </a>
                        ...
                        <form class="form-horizontal" id="myvaliForm" role="form" method="post">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="boss_job"class="form-control" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="boss_phone" class="form-control" >
                                        </div>
                                    </div>
                                    <div class="form-group last">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="boss_qq" class="form-control" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">邮箱</label>
                                        <div class="col-md-9">
                                            <input type="text" name="boss_email" class="form-control" >
                                        </div>
                                    </div>
                                </div>
    ...
    $(function () {
        $("#myvaliForm").bootstrapValidator({
            ...
            .on('success.form.bv', function(e) {
                ...
                $.ajax({
                    url: '<?php echo base_url('/admin/home/add')?>',
                    type: 'POST',
                    data: $("#myvaliForm").serialize(),
                    success: function(result) {
                        alert("succeed!");
                        location.href="/admin/home/boss";
                    }
                })
            })
    })
